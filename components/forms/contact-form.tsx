...
import { MessageSquare, CheckCircle, Loader2, Mail, Phone, User, Smartphone, MapPin, Clock } from "lucide-react"
          ...
          >
            ...
            >
              <p className="text-lg text-slate-500">
                ...
                <a href="tel:555-123-8324" className="font-semibold text-brand-600 hover:text-brand-700">
                  (555) 123-TECH
                </a>
              </p>
      ...
      <section className="pb-20 px-4 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-4xl">
          <div className="grid lg:grid-cols-3 gap-12">
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <p className="text-slate-600 leading-relaxed">
                    Ready to give your tech the care it deserves? We're here to help with any questions or service
                    needs.
                  </p>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-slate-500">On-site service available</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-slate-800 mb-1">Turnaround</h4>
                      <p className="text-slate-600">24-48 hours</p>
                      <p className="text-sm text-slate-500">Emergency service available</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Form */}
            <motion.div className="lg:col-span-2" {...fadeInUp} transition={{ delay: 0.8 }}>
                ...
                <CardContent className="space-y-6">
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    >
                      ...
                      <Textarea
                        ...
                        aria-describedby={errors.serviceRequested ? "service-error" : undefined}
                      />
                      {errors.serviceRequested && (
                        <p id="service-error" className="text-red-500 text-sm" role="alert">
                          {errors.serviceRequested}
                        </p>
                      )}
                    </motion.div>
                  ...
                  >
                    <p className="text-xs text-slate-400">
                      We typically respond within 2 hours during business days. Your information is secure and will
                      never be shared.
                    </p>
                  </motion.div>
                </CardContent>
