...
const questions: Question[] = [
  {
    ...
    icon: Laptop,
    options: [
      { text: "Lightning fast!", value: 0, icon: Smile, color: "text-emerald-600" },
  ...
  },
  {
    ...
    icon: Volume2,
    options: [
      { text: "Quiet as a whisper", value: 0, icon: CheckCircle, color: "text-emerald-600" },
  ...
  },
  {
    ...
    icon: AlertTriangle,
    options: [
      { text: "Never or rarely", value: 0, icon: CheckCircle, color: "text-emerald-600" },
  ...
  },
  {
    ...
    icon: Battery,
    options: [
      { text: "All-day champion", value: 0, icon: Smile, color: "text-emerald-600" },
  ...
  },
  {
    ...
    icon: Heart,
    options: [
      { text: "Confident and happy", value: 0, icon: Smile, color: "text-emerald-600" },
...
export default function TechHealthCheck() {
  ...
  const getHealthStatus = () => {
    ...
    if (percentage <= 20)
      return { status: "Excellent", color: "emerald", message: "Your device is in fantastic shape!" }
    if (percentage <= 40)
      return { status: "Good", color: "green", message: "Your device is doing well with minor areas to watch." }
    if (percentage <= 60) return { status: "Fair", color: "yellow", message: "Your device could use some attention." }
    return { status: "Needs Care", color: "red", message: "Your device needs professional attention soon." }
  }
  ...
  // Current question icon component
    ...
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-teal-50">
      ...
      >
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          {currentStep !== "welcome" && (
            <Button variant="ghost" onClick={() => setCurrentStep("welcome")} className="text-slate-600">
      ...
      <div className="container mx-auto px-6 py-12">
        <AnimatePresence mode="wait">
          ...
          {currentStep === "welcome" && (
            ...
            >
              <motion.div
                className="w-24 h-24 bg-gradient-to-br from-emerald-500 to-teal-600 rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-2xl"
                      ...
                      {questions[currentQuestion].options.map((option, index) => (
                        ...
                        >
                          <Button
                            ...
                            className="w-full p-6 h-auto border-2 border-slate-200 hover:border-emerald-300 hover:bg-emerald-50 rounded-2xl transition-all duration-300 group"
          ...
          {currentStep === "results" && (
            ...
            >
              ...
              >
                <Card className="border-0 shadow-2xl bg-gradient-to-br from-emerald-50 to-teal-50 rounded-3xl">
                  <CardContent className="p-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                      ...
                      <Button
                        variant="outline"
                        size="lg"
                        className="border-2 border-emerald-200 text-emerald-700 hover:bg-emerald-50 px-8 py-6 text-lg rounded-2xl bg-transparent"
                        whileHover={{ scale: 1.05 }}
                        whileTap={{ scale: 0.95 }}
                      >
